...
class FCFS extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == jb[2]) {
            ...
            // Sort processes based on arrival time and process ID
...
// Sort processes based on arrival time
            ...
            // Sort progress bars based on arrival time
            // Arrays.sort(progressBars, Comparator.comparingInt(pb -> processes[Integer.parseInt(pb.getName())].arrivalTime));
